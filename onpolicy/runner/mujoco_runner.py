...
class MujocoRunner(Runner):
    ...
    def eval(self, total_num_steps):
        ...
        while True:
            ...
            if eval_episode >= self.all_args.eval_episodes:
                ...
                self.log_env(eval_env_infos, total_num_steps+self.step_shift)
                break
    ...
    def seps_pretrain(self):
        ...
        # Start pretrain VAE
        agent_mapping = compute_clusters(self.buffer, self.num_agents, visualize=False)
